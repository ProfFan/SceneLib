...
/* Modified Feb 1996 by Ian Reid (ian@robots.ox.ac.uk) to cope with 
   ...
   way too large */
/* Small extra change by Andrew Davison (davison@etl.go.jp) adding
   case 15: for 15 bit screens (to do the same as 16 bit) and
   case 32: (same as 24 bit) */
